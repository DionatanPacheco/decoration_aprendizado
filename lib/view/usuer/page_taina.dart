...
class TaiPage extends StatelessWidget {
  const TaiPage({Key? key}) : super(key: key);
        ...
        child: Container(
          ...
          child: SingleChildScrollView(
            ...
            child: Column(children: [
                              ...
                              Column(
                                children: const [
                                  Padding(
                                    ...
                                    child: DesingText(
                                        title: 'Dra Taina Pedroti',
                                        titleSize: 8),
                                  ),
                                  DesingText(
                                      title:
                                          'Especialista em toc Limpeza-Torres',
                                      titleSize: 1)
                                ],
                              ),
                              const CircleAvatar(
                                backgroundImage:
                                    AssetImage('assets/taina.jpeg'),
                              ),
                            ],
                          ),
                        ),
                  ...
                  SizedBox(
                    ...
                    child: Container(
                      ...
                      child: Column(children: const [
                        ...
                        Padding(padding: EdgeInsets.all(8)),
                        DesingText(title: '+30 Anos', titleSize: 10)
                      ]),
                    ),
                  ),
                  SizedBox(
              ...
              const Text(
                'A doutora Taina Pedroti é especialista em toc de Limpeza e em ser dinda da Maria Eva',
                style: TextStyle(
