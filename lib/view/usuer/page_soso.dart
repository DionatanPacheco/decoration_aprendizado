...
class SosoPage extends StatelessWidget {
  const SosoPage({Key? key}) : super(key: key);
          ...
          children: [
            Column(
              children: [
                      ...
                      SizedBox(
                        ...
                        child: Container(
                          ...
                          child: Column(children: const [
                            ...
                            Padding(padding: EdgeInsets.all(8)),
                            DesingText(title: '+07 Anos', titleSize: 10)
                          ]),
                        ),
                      ),
                      SizedBox(
                ...
                const Text(
                  'A doutora Sofia Pedroti é especialista em dança e em bagunça.',
                  style: TextStyle(
                    ...
                    Column(
                      children: const [
                        ...
                        Padding(
                          ...
                          child: DesingText(
                              title: 'Especialista em dança e bagunça.',
                              titleSize: 60),
                        )
                      ],
                    ),
