...
class ZildoPage extends StatelessWidget {
  const ZildoPage({Key? key}) : super(key: key);
          ...
          children: [
            Column(
              children: [
                ...
                const Text(
                  'O doutor Rafael Freitas é especialista em churrasco e em ser o dindo Ogro da Maria Eva.',
                  style: TextStyle(
                    ...
                    Column(
                      children: const [
                        ...
                        Padding(
                          ...
                          child: DesingText(
                              title: 'Especialista em Churrasco',
                              titleSize: 60),
                        )
                      ],
                    ),
