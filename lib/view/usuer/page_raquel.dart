...
class RaquelPage extends StatelessWidget {
  const RaquelPage({Key? key}) : super(key: key);
          ...
          children: [
            Column(
              children: [
                      ...
                      SizedBox(
                        ...
                        child: Container(
                          ...
                          child: Column(children: const [
                            ...
                            Padding(padding: EdgeInsets.all(8)),
                            DesingText(title: '+37 Anos', titleSize: 10)
                          ]),
                        ),
                      ),
                      SizedBox(
                ...
                const Text(
                  'A doutora Raquel Ferreira é a manda chuva da galera e o Alicerce da familia.',
                  style: TextStyle(
                    ...
                    Column(
                      children: const [
                        ...
                        Padding(
                          ...
                          child: DesingText(
                              title: 'P.H.D em mandar na porra toda.',
                              titleSize: 60),
                        )
                      ],
                    ),
